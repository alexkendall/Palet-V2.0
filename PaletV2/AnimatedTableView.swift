...
class AnimatedTableView:UITableView, AnimatedViewProtocol
{
    ...
    init()
    {
        super.init(frame: CGRect(x: 0.0, y: 0.0, width: 0.0, height: 0.0), style: UITableViewStyle.Plain);
    }
    
    // must provide constructor that sets in and out frames
    init(in_frame:CGRect, out_frame:CGRect)
    {
        super.init(frame: in_frame, style: UITableViewStyle.Plain);
